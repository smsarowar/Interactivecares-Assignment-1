        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{route('category')}}" class="text-gray-400 hover:text-white transition">Categories</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{route('category')}}" class="text-gray-400 hover:text-white transition">Web Development</a></li>
